...
**[Bookstore]** is a minimalist app to display list of books.
...
```sh
  cd my-folder
  git clone https://github.com/Anand8317/bookstore.git
```
...
Feel free to check the [issues page](https://github.com/Anand8317/bookstore/issues).
